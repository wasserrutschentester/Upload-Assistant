...
tracker_class_map: dict[str, type[Any]] = {
    ...
    'R4E': R4E, 'RAS': RAS, 'RF': RF, 'RTF': RTF, 'RHD': RHD, 'SAM': SAM, 'SHRI': SHRI, 'SN': SN, 'SP': SP, 'SPD': SPD, 'STC': STC, 'THR': THR,
...
api_trackers = {
    ...
    'OE', 'OTW', 'PT', 'PTT', 'RAS', 'RF', 'R4E', 'RHD',  'SAM', 'SHRI', 'SP', 'STC', 'TIK', 'TLZ', 'TOS', 'TTR', 'ULCX', 'UTP', 'YOINK', 'YUS'
}
